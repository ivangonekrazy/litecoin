...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Logcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"logcointools.com", "dnsseed.logcointools.com"},
    {"logcoinpool.org", "dnsseed.logcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"logcointools.com", "testnet-seed.logcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Logcoin is probably already running."), addrBind.ToString().c_str());
        else
